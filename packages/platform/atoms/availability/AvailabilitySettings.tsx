...
type AvailabilitySettingsProps = {
  ...
  isDryRun?: boolean;
  /**
   * Rendered inside the page shell, below the availability form. A slot rather than letting
   * callers append a sibling: this component owns the whole Shell, so anything rendered after
   * it lands outside the content area and reads as if it were part of the nav.
   *
   * Taking a ReactNode keeps this package free of the caller's data layer — apps/web passes a
